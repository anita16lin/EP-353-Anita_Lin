...
<CsInstruments>
		instr 	118					
;k1      oscil   p4, 1/p3, p7 ;using osc as an envelope to control the amp of loscil
;k2      expseg  p5, p3/3, p8, p3/3, p9, p3/3, p5 ;k2 controls the frequency of a1
a1 		loscil  k1, k2*2, p6, 440
		out 	a1
		endin
